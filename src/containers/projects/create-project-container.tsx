...
export const CreateProjectContainer = () => {
  ...
  const formatProgressValue = (progressValue: number | string) => {
  ...
  const handleUpdateProject = (
    ...
    values: any,
    formatProgressValue: number | string,
    projects: IProject[]
  ) => {
    const errors = validateProjetValue(values, projects, selectedItem);
    if (Object.keys(errors).length > 0) {
              ...
              <div className="col-span-6 pr-10">
                ...
                <div className="group relative z-0 mb-5 w-full">
                  <input
                    ...
                    min="0"
                    max="100"
                    className="text-text-light/90 bg-transparent border-text-light peer mt-2 block w-full appearance-none border-b-2 px-0 py-2.5 text-sm focus:outline-none focus:ring-0"
                  />
